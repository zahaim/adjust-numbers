...
export function SeparatorControl({ separatorChar, isPlacementMode, onToggle, visible }: Props) {
...
export function SeparatorGap({ onPress, visible }: GapProps) {
  if (!visible) return null;
  return (
    <TouchableOpacity onPress={onPress} style={styles.gap} activeOpacity={0.5}>
